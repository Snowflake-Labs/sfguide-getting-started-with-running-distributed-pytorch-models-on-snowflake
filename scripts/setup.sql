...
-- Grant all privileges on the producer compute pool to the SYADMIN role
GRANT ALL PRIVILEGES ON COMPUTE POOL TASTYBYTESENDTOENDML_PRODUCER_POOL TO ROLE SYADMIN;
